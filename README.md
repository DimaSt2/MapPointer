Deploy - https://super-otter-d8c7c5.netlify.app/
...
Все кнопки не должны терять свою позицию при ширине экрана в промежутке от 1920px до 1280px (Идеальное совпадение не требуется, кнопки должны располагаться в пределах указанных построек)
